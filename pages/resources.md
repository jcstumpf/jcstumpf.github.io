...
## <a name="Data"></a>Data
#### <a name="Air Quality Sensor Data"></a>[data.gov.in](https://www.openaq.org/)
"Air quality measurements from 10,190 locations in 68 countries. Data are aggregated from 114 government level and research-grade sources."


#### <a name="qtl"></a>[Kaggle](https://www.kaggle.com/datasets)
Mortality dataset from 1980 - 2014 contains mortality rates of 21 causes of death.
